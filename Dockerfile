...
RUN wget https://sourceforge.net/projects/openofficeorg.mirror/files/4.1.6/binaries/en-US/Apache_OpenOffice_4.1.6_Linux_x86-64_install-rpm_en-US.tar.gz/download -O Apache_OpenOffice_4.1.6_Linux_x86-64_install-rpm_en-US.tar.gz \
